...
private val options = listOf(
    ...
    listOf("Оди", "У него есть ёжик?", "У него есть ёжик?, как из смешариков", "Тэхён"),
    ...
    private val pictures = listOf(
        listOf(R.drawable.txt1),
        listOf(R.drawable.txt2),
        listOf(R.drawable.txt3),
        listOf(R.drawable.txt4),
        listOf(R.drawable.txt5),
        listOf(R.drawable.txt6),
        listOf(R.drawable.txt7)
    )
